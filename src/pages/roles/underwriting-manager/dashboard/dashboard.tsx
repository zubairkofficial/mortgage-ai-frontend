    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <Card className="@container/card card-gradient-primary">
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span>
                {underwritingStats.completedToday} Reviews Completed Today
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm">
            ...
            {underwritingStats.complianceIssues > 0 && (
              <div className="flex items-center gap-2 text-sm text-amber-500">
                ...
                <span>
                  {underwritingStats.complianceIssues} Compliance Issues Flagged
                </span>
              </div>
            )}
          </div>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          ...
          <div className="text-muted-foreground">
            Review applications, maintain quality standards, and monitor audit
            trails
          </div>
        </CardFooter>
      </Card>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card
          ...
          onClick={() => navigate("/underwriting-manager/loan-validation")}
        >
        ...
        <Card
          className="hover:shadow-md transition-shadow cursor-pointer"
          onClick={() => navigate("/underwriting-manager/audit-trail")}
        >
          <CardContent className="flex flex-col items-center justify-center p-6">
        ...
        <Card
          className="hover:shadow-md transition-shadow cursor-pointer"
          onClick={() => navigate("/underwriting-manager/reports")}
        >
          <CardContent className="flex flex-col items-center justify-center p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <CardContent>
            <div className="flex justify-between items-end">
              <div className="text-3xl font-bold">
                {underwritingStats.approvalRate.value}%
              </div>
              <div
              ...
              >
                ...
                <span className="text-xs">
                  {underwritingStats.approvalRate.changePercent}%
                </span>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex justify-between items-end">
              <div className="text-3xl font-bold">
                {underwritingStats.averageTurnaround}
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex justify-between items-end">
              <div className="text-3xl font-bold">
                {underwritingStats.efficiencyRate.value}%
              </div>
              <div
                className={`flex items-center gap-1 text-sm ${
              ...
              >
                ...
                <span className="text-xs">
                  {underwritingStats.efficiencyRate.changePercent}%
                </span>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="flex items-center mb-4">
              ...
              <div>
                <p className="mb-2">
                  Ensure loan compliance with all regulations:
                </p>
