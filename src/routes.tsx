...
import BrokerLayout from "./pages/roles/broker/layout/layout";
...
import BrokerDashboard from "./pages/roles/broker/dashboard/dashboard";
...
import BrokerApplicationTable from "./pages/roles/broker/application/application-table";
...
const router = createBrowserRouter([
  ...
  // Broker Portal Routes
  {
    ...
    children: [
      ...
      {
        path: "application",
        element: <BrokerApplicationTable />,
      },
      {
  ...
  // Account Executive Portal Routes
  {
    ...
    element: <AccountExecutiveLayout />,
    children: [
      {
        path: "dashboard",
  ...
  // Underwriting Manager Portal Routes
  {
    ...
    element: <UnderwritingManagerLayout />,
    children: [
      {
        path: "dashboard",
