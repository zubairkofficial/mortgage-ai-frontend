...
export function MessageList({
          ...
          >
            <div className="max-w-md">
              ...
              >
                ...
                {message.isRead && message.isSender && (
          ...
          >
            <div className="max-w-md">
              ...
              >
                ...
                {message.isRead && message.isSender && (
                  <Check className="h-4 w-4 ml-1 text-brand-teal" />
                )}
              </div>
            </div>
          </div>
              ...
              <div className="bg-background rounded-lg shadow-sm">
                <div className="relative">
                  ...
                  <div className="absolute top-3 left-3 flex items-center">
                    ...
                    <span className="ml-2 text-background font-medium text-sm">
                ...
                {message.isStreaming && (
                  <div className="flex items-center mt-2">
                    <div className="flex">
                      ...
                      <div
                        className="w-1 h-1 rounded-full bg-brand-blue animate-pulse mr-1"
                        style={{ animationDelay: "0.2s" }}
                      ></div>
                      <div
                        className="w-1 h-1 rounded-full bg-brand-blue animate-pulse"
  ...
  return (
    <div className="w-full px-5 flex flex-col justify-between bg-background absolute max-h-[80%] overflow-y-scroll">
      <div className="flex flex-col mt-5">
        {/* Time Header */}
        <div className="text-center mb-6">
          <span className="bg-background text-muted-foreground text-xs px-3 py-1 rounded-full">
            Today
          </span>
        </div>
        ...
        {isTyping && typingRole && (
          <div className="flex items-center text-muted-foreground text-sm mt-2">
            <UserAvatar user={typingRole} size="sm" />
            <div className="ml-2">
              <p className="text-xs font-medium">{typingRole.name}</p>
              <div className="flex items-center">
                <span>typing</span>
                <span className="flex ml-1">
                  <span className="animate-bounce mx-0.5 opacity-60">.</span>
                  <span
                    className="animate-bounce mx-0.5 opacity-60"
                    style={{ animationDelay: "0.2s" }}
                  >
                    .
                  </span>
